...
## 🇮🇩 Catatan Adaptasi Indonesia (Pemdi/PDP)

Untuk konteks Pemerintah Indonesia (terutama finalisasi bukti dukung Indikator 8 — Pelindungan Data Pribadi, PermenPANRB 8/2026):

- **Dasar hukum Indonesia**: UU No. 27/2022 tentang Pelindungan Data Pribadi (PDP) + PP turunan. Konsep sejajar GDPR: subjek data (data subject), Pejabat/Petugas PDP/DPO, pemberitahuan privasi (privacy notice), hak subjek data, pemrosesan data pribadi, pelanggaran data (breach).
- **Kesamaan istilah** yang membantu drafting bukti I8: consent → persetujuan, DPO → Pejabat/Petugas Pelindungan Data Pribadi (PPDP), DPIA → kajian dampak pelindungan data, breach notification → pemberitahuan pelanggaran data (72 jam → 3x24 jam).
- **Gunakan kerangka GDPR untuk menyusun**: uraian tata kelola PDP existing, kebijakan PDP, prosedur pemenuhan hak subjek data, mekanisme privacy notice, program awareness PDP, evaluasi pengamanan data — lalu sesuaikan pasal/nomenklatur dengan UU 27/2022.
- **Data Dukung I8 L1 (ground truth)**: uraian 7 kondisi penerapan PDP (tata kelola, awareness, penunjukan PPDP/DPO, hak subjek data, pemberitahuan, pengamanan, pengelolaan risiko).
