...
- `references/niumination-core-v2.md` — hukum ekosistem (12 Hukum, MODEL.policy Zen-only, FREEZE.list, HANDOFF/fence, ledger no-agent) dari paket niumination-rebuild-v2. **Agama baru ekosistem: hanya opencode-zen/big-pickle + deepseek-v4-flash-free boleh berpikir; v2 MENGGANTI v1** — baca sebelum mengerjakan tugas core apa pun di Niumination