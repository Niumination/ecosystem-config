...
# compares with ~/.cache/niumination/9router-models.hash, updates cache.
# Debounce: only commit change if hash stable for DEBOUNCE_WINDOW seconds.
set -u
...
STABLE_FILE="$CACHE_DIR/9router-models.stable"
