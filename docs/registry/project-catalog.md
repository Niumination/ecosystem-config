...
||| **Mobile-Harness** | `apps/Mobile-Harness/` 🏭 | Android (Kotlin, Jetpack Compose), PRoot Linux, Claude Code CLI | `github.com/Niumination/Mobile-Harness` | 🟢 GitHub | 08 Sep 2026 | 🆕 **Claude Code on Android — mobile AI coding IDE** |
