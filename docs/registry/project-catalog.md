...
||| **Niu-OSS-Dashboard** | `sites/niu-oss-dashboard/` | Next.js 16.3, React 19.2, TS 7, Tailwind, R3F, Vitest 5 | `github.com/Niumination/Niu-OSS-Dashboard` | ⚪ Vercel — **fase 4 go-live pending** (DNS `niumination.web.id` belum ada) | 19 Sep 2026 | 🆕 **Landing + dashboard OSS 91 repo, API publik v1, PWA, i18n id/en — 11 commit riwayat asli; CVE-2025-66478 tertutup (stack 2026)** |
