...
| **cc-acehtengah** | `services/cc-acehtengah/` | Next.js 16, Supabase | `github.com/Niumination/cc-acehtengah` | 💤 **Hiatus** — Vercel di-pause; repo archived+private | 21 Sep 2026 | 💤 **Pindah ke `sapa-ai` (permintaan client)** — folder lokal utuh, tag `v-hiatus-2026-09-21`; restore lihat `docs/reports/HIATUS-CC-ACEHTENGAH-2026-09-21.md` |
