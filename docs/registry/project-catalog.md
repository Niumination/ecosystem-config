...
| **cc-acehtengah** | ~~`services/cc-acehtengah/`~~ | Next.js 16, Supabase | `github.com/Niumination/cc-acehtengah` | 💤 **Hiatus — folder lokal dihapus** | 21 Sep 2026 | 💤 **Pindah ke `sapa-ai` (permintaan client)** — backup 75 MB di `vault/_hibernasi-cc-acehtengah-2026-09-21/` (656 berkas, SHA-256); repo archived+private; restore lihat `docs/reports/HIATUS-CC-ACEHTENGAH-2026-09-21.md` |
